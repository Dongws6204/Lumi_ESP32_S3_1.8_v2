...
void Protocol::SendStartListening(ListeningMode mode) {
    ...
    message += ",\"language\":\"" + std::string(Lang::CODE) + "\"";
    message += ",\"locale\":\"" + std::string(Lang::CODE) + "\"";
    message += ",\"asr_language\":\"" + std::string(Lang::CODE) + "\"";
    message += ",\"tts_language\":\"" + std::string(Lang::CODE) + "\"";
    message += "}";
    ESP_LOGI(TAG, "[LANG] listen payload = %s", message.c_str());
    SendText(message);
}
