...
private:
    ...
    bool music_stopped_for_tts_ = false;
    PendingMusicRequest pending_music_;
    int clock_ticks_ = 0;
    ...
    bool IsTtsActive();
    void StopActiveMusicForTtsOnce();
    void StartPendingMusicAfterTts();
